...
export function fetchPinnacleNba(apiKey: string): Promise<PinnacleGame[]> {
  return fetchSport('basketball_nba', apiKey)
}

export function fetchPinnacleMlb(apiKey: string): Promise<PinnacleGame[]> {
  return fetchSport('baseball_mlb', apiKey)
}

export function fetchPinnacleNhl(apiKey: string): Promise<PinnacleGame[]> {
